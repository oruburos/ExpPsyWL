var Model= {
    ...
    msgmodel : "hola desde model",
     getPalValue : function (leisureActivityLevel, workActivityLevel) {
             Model.activityLevelValue = 0;
	...
	WorkActivityLevel: {
        ...
        BodyChange : function (df, dl, dg, dDecw, dtherm) {
            this.df = df || 0;
            this.dl = dl || 0;
            this.dg = dg || 0;
            this.dDecw = dDecw || 0;
